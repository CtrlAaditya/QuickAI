  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <input onChange={(e)=>setObject(e.target.files[0])} type="file"
        accept='image/*'
      ...
      <p className='mt-6 text-sm font-medium'>Describe Object name to Remove</p>
        <textarea onChange={(e)=>setInput(e.target.value)} value={object} rows={4}
          className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300'
          placeholder='e.g., Watch or Spoon, only single onject name'
          required
        />
      ...
      border-gray-200 min-h-96'>
        ...
        <div className='flex-1 flex justify-center items-center'>
            ...
            text-gray-400'>
              ...
              <p>Upload an Image and click "Remobe object" to get started</p>
            </div>
        </div>
