...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
              Experience the power of Quick.Ai.<br/>
              Unlock smarter workflows with Quick.Ai today.
              Create, enhance, and scale—all in one place.
              Built for speed, crafted for creators like you.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025cd client
         © Quick.AI All Right Reserved.
    </p>
</footer>
  )
}
